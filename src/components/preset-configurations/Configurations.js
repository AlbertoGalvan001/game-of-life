...
`;
const loafAlt = `a structure minimally representing a loaf of bread using cells. With 4 cells in the center of the structure, the bottom left of this structure is filled in
